...
- **bip39** + **ed25519-hd-key** — Mnemonic generation and Solana key derivation
...
The wallet connects to Solana mainnet-beta (`https://api.mainnet-beta.solana.com`) by default. To change the RPC endpoint, edit `SOLANA_RPC_URL` in `types.ts`.
